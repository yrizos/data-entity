...
class TypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRaw()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\RawType", $type);
    ...
    public function testString()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\StringType", $type);
    ...
    public function testInteger()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\IntegerType", $type);
    ...
    public function testBoolean()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\BooleanType", $type);
    ...
    public function testArray()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\ArrayType", $type);
    ...
    public function testSerialized()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\SerializedType", $type);
    ...
    public function testEmail()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\EmailType", $type);
    ...
    public function testDate()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\DateType", $type);
    ...
    public function testAlnum()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\AlnumType", $type);
    ...
    public function testFloat()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\FloatType", $type);
    ...
    public function testIp()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\IpType", $type);
    ...
    public function testUrl()
    {
        ...
        $this->assertInstanceOf("DataEntity\\Type\\UrlType", $type);
